...
<head>
    ...
    <title>Luizão Atacarejo - Padaria</title>
...
<body>
            ...
            <div class="produtos-container">
                ...
                ?>
                        <div class="box">
                            ...
                            <span><?php echo htmlspecialchars($row['subcategoria']); ?></span>
    ...
    <?php
        ...
        // SQL Base
        $where_sql = "WHERE categoria = 'Padaria'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="padaria.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>

                    <a href="padaria.php?sub=pao" class="filter-link <?php echo ($filtro_sub == 'pao') ? 'active' : ''; ?>">
                        <span>Pães</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="padaria.php?sub=doce" class="filter-link <?php echo ($filtro_sub == 'doce') ? 'active' : ''; ?>">
                        <span>Bolos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="padaria.php?sub=salgado" class="filter-link <?php echo ($filtro_sub == 'salgado') ? 'active' : ''; ?>">
                        <span>Salgados</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="padaria.php?sub=outros" class="filter-link <?php echo ($filtro_sub == 'outros') ? 'active' : ''; ?>">
            ...
            <section class="padaria" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // --- TRADUTOR DE TÍTULOS ---
                ...
                <div class="container">
                    ...
                    <?php
                        ...
                        echo "<div style='width: 100%; text-align: center; grid-column: 1 / -1; padding: 40px;'>";
