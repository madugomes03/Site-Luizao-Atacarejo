...
<body>
        ...
        <div class="mobile-menu-content">
            <div class="dropdown mobile-dropdown">
                <button class="dropdown-toggle">
                    <i class='bx bxs-grid-alt'></i> Todas as categorias </i>
                </button>
            </div>
    ...
    ?>
        <section class="produtos" id="resultados-busca" style="padding: 2% 8%; background-color: #fff;">
            ...
            <div class="produtos-container">
                ...
                ?>
                        <div class="box <?php echo htmlspecialchars($row["subcategoria"]); ?>" 
                             data-nome="<?php echo htmlspecialchars($row["nome"]); ?>"
                             data-preco="<?php echo htmlspecialchars($row["preco"]); ?>">
                            ...
                            <h3 class="preço"> R$ <?php echo htmlspecialchars($row["preco"]);?><span> por <?php echo htmlspecialchars($row["descricao"]); ?></span></h3>
                        </div>
                <?php
                    }
                } else {
    ...
    <?php
        ...
        $where_sql = "WHERE categoria = 'Higiene'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="higiene.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>

                    <a href="higiene.php?sub=bucal" class="filter-link <?php echo ($filtro_sub == 'bucal') ? 'active' : ''; ?>">
                        <span>Higiene bucal</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="higiene.php?sub=banho" class="filter-link <?php echo ($filtro_sub == 'banho') ? 'active' : ''; ?>">
                        <span>Sabonetes e Banho</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="higiene.php?sub=cabelo" class="filter-link <?php echo ($filtro_sub == 'cabelo') ? 'active' : ''; ?>">
                        <span>Cabelos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="higiene.php?sub=pessoal" class="filter-link <?php echo ($filtro_sub == 'pessoal') ? 'active' : ''; ?>">
                        <span>Cuidados Pessoais</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="higiene.php?sub=papel" class="filter-link <?php echo ($filtro_sub == 'papel') ? 'active' : ''; ?>">
            ...
            <section class="higiene" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // Títulos Bonitos
                ...
                <div class="container">
                    ...
                    ?>
                            <div class="box <?php echo htmlspecialchars($registro["subcategoria"]); ?>"
                                ...
                                <h3 class="preço"> R$<?php echo htmlspecialchars($registro["preco"]); ?><span> por <?php echo htmlspecialchars($registro["descricao"]); ?> </span></h3>
                    ...
                    <?php
                        ...
                        echo "<h3>Nenhum produto encontrado em: <b>" . ($filtro_sub ? htmlspecialchars($titulos_amigaveis[$filtro_sub] ?? $filtro_sub) : "") . "</b></h3>";
                        echo "</div>";
                    }
                    ?>
                </div>
