...
<body>
    ...
    <?php
        ...
        // --- 1. LÓGICA DE PAGINAÇÃO E FILTROS ---
        ...
        // Monta o SQL Base
        $where_sql = "WHERE categoria = 'Frios e Laticínios'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="frios.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>

                    <a href="frios.php?sub=leite" class="filter-link <?php echo ($filtro_sub == 'leite') ? 'active' : ''; ?>">
                        <span>Leites</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="frios.php?sub=iogurte" class="filter-link <?php echo ($filtro_sub == 'iogurte') ? 'active' : ''; ?>">
                        <span>Iogurtes</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="frios.php?sub=manteiga" class="filter-link <?php echo ($filtro_sub == 'manteiga') ? 'active' : ''; ?>">
                        <span>Manteigas e Margarinas</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="frios.php?sub=queijo" class="filter-link <?php echo ($filtro_sub == 'queijo') ? 'active' : ''; ?>">
                        <span>Queijo e Requeijão</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="frios.php?sub=fatiados" class="filter-link <?php echo ($filtro_sub == 'fatiados') ? 'active' : ''; ?>">
                        <span>Congelados/Outros</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                </div>
            </aside>

            <section class="frios" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // Título Amigável
                        $titulos_amigaveis = [
                            ...
                            'queijo'   => 'Queijos e Requeijão',
                            'fatiados' => 'Congelados/Outros'
                        ];
