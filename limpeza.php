...
<head>
    ...
    <title>Luizão Atacarejo - Limpeza</title>
...
<body>
    ...
    <?php
        ...
        // --- CONFIGURAÇÃO PAGINAÇÃO & FILTROS ---
        $itens_por_pagina = 15; 
        ...
        // SQL Base
        $where_sql = "WHERE categoria = 'Limpeza'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="limpeza.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>
                    
                    <a href="limpeza.php?sub=sabao" class="filter-link <?php echo ($filtro_sub == 'sabao') ? 'active' : ''; ?>">
                        <span>Limpeza de Roupas</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="limpeza.php?sub=detergente" class="filter-link <?php echo ($filtro_sub == 'detergente') ? 'active' : ''; ?>">
                        <span>Limpeza de Cozinha</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="limpeza.php?sub=desinfetante" class="filter-link <?php echo ($filtro_sub == 'desinfetante') ? 'active' : ''; ?>">
                        <span>Limpeza de Banheiro</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                    
                    <a href="limpeza.php?sub=utensilios" class="filter-link <?php echo ($filtro_sub == 'utensilios') ? 'active' : ''; ?>">
            ...
            <section class="limpeza" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // Título Amigável
                        $titulos_amigaveis = [
                            ...
                            'utensilios'   => 'Utensílios e Limpeza Geral'
                        ];
        ...
        <div id="quick-view-modal" class="quick-view-modal">
            ...
            <div class="quick-view-content">
                ...
                <div class="quick-view-details">
                    ...
                    <button class="add-to-cart-btn">Adicionar ao Carrinho</button> </div>
            </div>
        </div>
    </div>
