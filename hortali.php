...
<body>
    ...
    <?php
        ...
        // SQL Base
        $where_sql = "WHERE categoria = 'Hortifruti'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="hortali.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>

                    <a href="hortali.php?sub=frutas" class="filter-link <?php echo ($filtro_sub == 'frutas') ? 'active' : ''; ?>">
                        <span>Frutas</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="hortali.php?sub=verduras" class="filter-link <?php echo ($filtro_sub == 'verduras') ? 'active' : ''; ?>">
                        <span>Verduras</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="hortali.php?sub=legume" class="filter-link <?php echo ($filtro_sub == 'legume') ? 'active' : ''; ?>">
                        <span>Legumes</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="hortali.php?sub=temperos" class="filter-link <?php echo ($filtro_sub == 'temperos') ? 'active' : ''; ?>">
                        <span>Temperos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                </div>
            ...
            <section class="hortifruti" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // Título Amigável
