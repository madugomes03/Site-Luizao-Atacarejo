...
<body>
    ...
    ?>
        <section class="produtos" style="padding: 2% 4%; background-color: #fff;">
                ...
                ?>
                        <div class="box">
                            <div class="img-container">
                                <img src="sb-admin/phpADM/<?php echo htmlspecialchars($row['path']); ?>" alt="<?php echo htmlspecialchars($row['nome']); ?>" />
                                <div class="cart card-add-btn <?php echo htmlspecialchars($row["status"]); ?>"><i class='bx bx-plus'></i></div>
                                <button class="quick-view-btn" 
                                        data-nome="<?php echo htmlspecialchars($row["nome"]); ?>"
                                        data-preco="R$ <?php echo htmlspecialchars($row["preco"]); ?>"
                                        data-descricao="por <?php echo htmlspecialchars($row["descricao"]); ?>"
                                        data-imagem="sb-admin/phpADM/<?php echo htmlspecialchars($row["path"]); ?>">
                            ...
                            <h3 class="preço"> R$<?php echo htmlspecialchars($row['preco']); ?> <span> / <?php echo htmlspecialchars($row['descricao']); ?> </span></h3>
                        </div>
                <?php
                    }
                } else {
    ...
    <?php
        ...
        $where_sql = "WHERE categoria = 'Mercearia'";
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="mercearia.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>
                    
                    <a href="mercearia.php?sub=graos" class="filter-link <?php echo ($filtro_sub == 'graos') ? 'active' : ''; ?>">
                        <span>Alimentos Básicos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="mercearia.php?sub=oleos" class="filter-link <?php echo ($filtro_sub == 'oleos') ? 'active' : ''; ?>">
                        <span>Itens Gerais</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="mercearia.php?sub=farinha" class="filter-link <?php echo ($filtro_sub == 'farinha') ? 'active' : ''; ?>">
                        <span>Farinhas e Farofas</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="mercearia.php?sub=enlatados" class="filter-link <?php echo ($filtro_sub == 'enlatados') ? 'active' : ''; ?>">
                        <span>Enlatados</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="mercearia.php?sub=cafe" class="filter-link <?php echo ($filtro_sub == 'cafe') ? 'active' : ''; ?>">
                        <span>Biscoitos e Ensacados</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="mercearia.php?sub=massas" class="filter-link <?php echo ($filtro_sub == 'massas') ? 'active' : ''; ?>">
                        <span>Massas e Molhos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                </div>
            </aside>

            <section class="mercearia" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        $titulos_amigaveis = [
                        ...
                        if (!empty($filtro_sub)) {
                            // Se existir na lista de tradução, usa o nome bonito. Se não, usa o original.
                ...
                <div class="container">
                    ...
                    ?>
                            <div class="box <?php echo htmlspecialchars($registro['subcategoria']); ?>"
                                data-nome="<?php echo htmlspecialchars($registro["nome"]); ?>"
                                data-preco="<?php echo htmlspecialchars($registro["preco"]); ?>">
                                
                                <div class="img-container">
                                    <img src="sb-admin/phpADM/<?php echo htmlspecialchars($registro["path"]); ?>" alt="<?php echo htmlspecialchars($registro["nome"]); ?>" />
                                    <div class="cart card-add-btn <?php echo htmlspecialchars($registro["status"]); ?>"><i class='bx bx-plus'></i></div>
                                    <button class="quick-view-btn" 
                                            data-nome="<?php echo htmlspecialchars($registro["nome"]); ?>"
                                            data-preco="R$ <?php echo htmlspecialchars($registro["preco"]); ?>"
                                            data-descricao="por <?php echo htmlspecialchars($registro["descricao"]); ?>"
                                            data-imagem="sb-admin/phpADM/<?php echo htmlspecialchars($registro["path"]); ?>">
                                        <i class='bx bx-search-alt-2'></i>
                                    </button>
                                    <div class="card-quantity-selector">
                                        <button class="qty-btn qty-remove"><i class='bx bx-trash'></i></button>
                                ...
                                <span><?php echo htmlspecialchars($registro['categoria']); ?></span>
                                <h2><?php echo htmlspecialchars($registro["nome"]); ?></h2>
                                <h3 class="preço"> R$<?php echo htmlspecialchars($registro["preco"]); ?><span> / <?php echo htmlspecialchars($registro["descricao"]); ?> </span></h3>
                            </div>
                    <?php
                        }
                    } else {
                        $nome_erro = $filtro_sub;
                        if(array_key_exists($filtro_sub, $titulos_amigaveis)) {
                            $nome_erro = $titulos_amigaveis[$filtro_sub];
                        }

                        echo "<div style='width: 100%; text-align: center; padding: 40px; grid-column: 1 / -1;'>";
                        echo "<h3>Nenhum produto encontrado em: <b>" . ($filtro_sub ? $nome_erro : "") . "</b></h3>";
                        echo "<p>Pode ser que o nome no link não seja igual ao do banco de dados.</p>";
                        echo "</div>";
                    }
                    ?>
                </div>
                ...
                <?php
                //  Conta APENAS os produtos filtrados
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="cart-menu">
            <h3>Meu Carrinho</h3>
            <div class="cart-item">Seu carrinho está vazio.</div>
        </div>
    ...
    <div id="quick-view-overlay" class="quick-view-overlay">
        <div id="quick-view-modal" class="quick-view-modal">
            ...
            <div class="quick-view-content">
                <img id="quick-view-img" src="" alt="Imagem" />
                <div class="quick-view-details">
                    <h2 id="quick-view-nome">Produto</h2>
                    <h3 id="quick-view-preco">R$ 0,00</h3>
