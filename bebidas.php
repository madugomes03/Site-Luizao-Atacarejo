...
<head>
    ...
    <title>Luizão Atacarejo - Bebidas</title>
...
<body>
    ...
    <?php
        ...
        // Monta o SQL Base
        $where_sql = "WHERE categoria = 'Bebidas'";
        if (!empty($filtro_sub)) {
        ...
        <main class="subcategoria-content">
            <aside class="filter-sidebar">
                ...
                <div class="filter-group">
                    ...
                    <a href="bebidas.php" class="filter-link <?php echo (empty($filtro_sub)) ? 'active' : ''; ?>">
                        <span>Ver Todos</span>
                        <i class='bx bx-grid-alt'></i>
                    </a>

                    <a href="bebidas.php?sub=refrigerante" class="filter-link <?php echo ($filtro_sub == 'refrigerante') ? 'active' : ''; ?>">
                        <span>Refrigerantes/Energéticos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="bebidas.php?sub=suco" class="filter-link <?php echo ($filtro_sub == 'suco') ? 'active' : ''; ?>">
                        <span>Sucos e Refrescos</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="bebidas.php?sub=cerveja" class="filter-link <?php echo ($filtro_sub == 'cerveja') ? 'active' : ''; ?>">
                        <span>Alcoólicas</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>

                    <a href="bebidas.php?sub=destilados" class="filter-link <?php echo ($filtro_sub == 'destilados') ? 'active' : ''; ?>">
                        <span>Bebidas Lácteas e Outros</span>
                        <i class='bx bx-chevron-right'></i>
                    </a>
                </div>
            </aside>

            <section class="bebidas" id="produtos">
                <div class="cabeçalho dois">
                    <h1> 
                        <?php 
                        // Tradução dos Títulos
                        $titulos_amigaveis = [
                            'refrigerante' => 'Refrigerantes e Energéticos',
                ...
                <div class="container">
                    <?php
                    // Busca produtos com filtro e limite
